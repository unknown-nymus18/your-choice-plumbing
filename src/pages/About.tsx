          ...
          <FadeIn>
            <div className="intro-content">
              ...
              <p className="lead">
                ...
                Legon, Ghana. We've built our reputation on delivering
                exceptional plumbing services with unwavering commitment to
            ...
            <FadeIn>
              <div className="story-content">
                ...
                <p>
                  ...
                  services to our community, Your Choice Plumbing has grown from
                  a small local operation to one of the most trusted plumbing
                  companies in Legon.
                </p>
          ...
          <div className="values-grid">
            ...
            <FadeIn>
              <div className="value-card">
                ...
                <h3>Transparency</h3>
                <p>
                  No hidden fees, no surprises. We provide clear, upfront
                  pricing and honest assessments of every plumbing situation.
                </p>
              </div>
            </FadeIn>
            <FadeIn>
              <div className="value-card">
                ...
                <p>
                  As a local business, we're invested in our community's
                  success. We're not just your plumbers; we're your neighbors.
                </p>
              </div>
            </FadeIn>
          </div>
          ...
          <div className="services-grid">
            ...
            <FadeIn>
              <div className="service-item">
                ...
                <h3>Pipe Works</h3>
                <p>
                  Professional pipe installation, repair, and replacement
          ...
          <div className="reasons-grid">
            ...
            <FadeIn>
              <div className="reason-card">
                ...
                <p>
                  No surprises on your bill. We provide clear, detailed
